    ...
    <div class="container ">
        <div class="sec-heading">
            <div class="content-area">
                ...
                <h2 class="title wow fadeInUp" data-wow-delay=".4s">Dernières <span
                        class="hollow-text">actualités</span></h2>
            </div>
            <div class="cta-area wow fadeInUp" data-wow-delay=".8s">
                <a class="cta-btn btn-solid" href="#">Tous nos articles<i class="bi bi-arrow-right icon"></i></a>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="post-box">
                                    ...
                                    <div class="post-summary">
                                        <div class="post-info">
                                            <a class="info post-cat" href="#"><i
                                                    class="bi bi-bookmark icon"></i>{{ $post['category'] }}</a>
                                            <a class="info post-author" href="#"><i
                                                    class="bi bi-person icon"></i>{{ $post['author'] }}</a>
                                        </div>
                                        <div class="post-text">
                                            ...
                                            <a class="read-more" href="#" title="{{ $post['title'] }}">Lire la suite<i
